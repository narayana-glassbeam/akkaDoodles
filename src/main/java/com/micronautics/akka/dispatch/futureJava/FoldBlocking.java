...
class FoldBlocking {
    ...
    private final ExecutionContext daemonContext = new ExecutionContext() {
        public void execute(Runnable runnable) { daemonExecutorService.execute(runnable); }
    };
    ...
    public void doit() {
        ...
        System.out.println("Blocking Java fold: " + result.size() + " web pages contained 'Simpler Concurrency'.");
    }
